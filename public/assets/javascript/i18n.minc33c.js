        ...
        function c(t) {
            var e = (function (t) {
                for (var e, r, n, i, a = [], p = []; (e = t.match(u)); ) {
                    for (
                        r = e[0],
                            (n = t.substr(0, e.index).trim()) && a.push(n);
                        (i = p.pop());
                    ...
                    p = (t, e, n) => {
                        ...
                        return r
                            ? ((i = r.applyFilters(
                              ...
                              r.applyFilters(
                                  "i18n.gettext_with_context_" + u(n),
                                  i,
                                  t,
                                  e,
                                  n
